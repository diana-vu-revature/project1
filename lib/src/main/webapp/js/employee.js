...
function createUserForm(user) {
  ...
  for(const prop in user) {
    ...
    label.for = prop;
    switch(prop) {
      case "id": label.innerHTML = "ID: "; break;
      case "roleId": label.innerHTML = "Role ID: "; break;
      case "fname": label.innerHTML = "First Name: "; break;
      case "surname": label.innerHTML = "Last Name: "; break;
      case "email": label.innerHTML = "Email: "; break;
      case "pword": label.innerHTML = "Password: "; break;
      default: label.innerHTML = prop;
    }
